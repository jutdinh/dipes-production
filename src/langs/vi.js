export default {
  ...
  select_export_condition: "Chọn điều kiện xuất",
  "file name": "Tên tệp",
  "type file": "Dạng tệp",
  ...
  back: "Quay lại",
  copied: "Đã sao chép!",
  "Number of rows exceeds the allowable limit":
    "Số hàng vượt quá giới hạn cho phép",
  "File size exceeds the allowable limit":
    "Kích thước tệp vượt quá giới hạn cho phép (Tối đa 120MB)",
  ...
  step: "Bước",
  condition_fields: "Trường điều kiện",
  unique_fields: "Trường duy nhất",
  "upload file": "Tải File",
  "get data": "Nhận Dữ Liệu",
  "get result": "Lấy Kết Quả",
  "note not share":
    "Lưu ý: Không chia sẻ khóa này cho bất kỳ ai không được ủy quyền.",
  ...
  "You have not rated the quality of support":
    "Bạn chưa đánh giá chất lượng của dịch vụ hỗ trợ",
  ...
  "Case title, case description, or anything":
    "Tiêu đề trường hợp, mô tả trường hợp",
  "Show more": "Xem thêm",
  ...
  "Only image, video, PDF, and Excel files are accepted":
    "Chỉ chấp nhận các tệp hình ảnh, video, Pdf và Excel",
  ...
  withdraw:
    "Thông tin chỉ có thể được cập nhật trong vòng 24 giờ kể từ khi gửi.",
  "Drag and drop images here and click":
