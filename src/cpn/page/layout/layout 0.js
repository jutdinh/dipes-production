...
export default (props) => {
  ...
  useEffect(() => {
    socket.on("/dipe-production-delete-data", (newData) => {
      ...
      const indexToDelete = apiData.findIndex((item) =>
        matchesAllKeys(item, newData.key)
      );
  ...
  const handleViewDetail = async (record) => {
    ...
    if (api_detail != undefined) {
      ...
      if (success) {
        ...
        openTab(
          `/page/${url}/detail/${id_str}/${stringifiedParams}?myParam=${url}`
        );
      }
    } else {
      Swal.fire({
                    ...
                    >
                      {dataStatis && dataStatis.length > 0 ? (
                        <>
                          ...
                          <a
                            className={`nav-item nav-link ${
                              activeTab === "nav-profile_s2" ? "active" : ""
                            }`}
                            id="nav-profile-tab"
                            data-toggle="tab"
                            href="#nav-profile_s2"
                ...
                <div class="tab_style2">
                  <div class="tabbar padding_infor_info">
                    <div class="tab-content" id="nav-tabContent">
                      <div
                        class={`tab-pane fade ${
                          activeTab === "nav-home_s2" ? "show active" : ""
                        }`}
                        id="nav-home_s2"
                        role="tabpanel"
                                                      ...
                                                      <tr key={index}>
                                                        ...
                                                        >
                                                          ...
                                                          "uad" ? (
                                                            <>
                                                              <i
                                                                className="fa fa-edit size-24 pointer ml-2 icon-margin icon-edit"
                                                                onClick={() =>
                                                                  redirectToInputPUT(
                                                                    row
                                                                  )
                      ...
                      <div
                        class={`tab-pane fade ${
                          activeTab === "nav-profile_s2" ? "show active" : ""
                        }`}
                        id="nav-profile_s2"
                        role="tabpanel"
