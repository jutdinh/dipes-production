      ...
      if (areAllQueriesReturnAtLeastOneRecord) {
        ...
        if (areAllForeignKeyValid) {
          for (let i = 0; i < sortedBody.length; i++) {
            ...
            const slaves = this.detectAllSlave(table);
            console.log("DETECT SLAVE", slaves, table, "END DETEC SLAVE");
            ...
            // foreignkey, slave, data type
            console.log("UPDATE HERE AFTER::", table_alias, updateQuery, data);

            await Database.update(table_alias, updateQuery, data);
            // await Database.updateMany(table_alias, [
            //   {
            //     condition: {
            //       "8MLSX": "LSX-2024226-000001",
            //       "7KV": "KH002",
            //     },
            //     value: {
            //       "3SLMV": "23",
